...
describe('DEL /file/container/:containerId/:id', () => {
  ...
  describe('one node', () => {
    ...
    it('should delete a file', done => {
      ...
      let filePath1 = path.join(__dirname, 'datasets', 'del', 'data_1', 'test', filename + '.enc');

      createDirIfNotExistsSync(path.join(__dirname, 'datasets', 'del', 'data_1'));
      createDirIfNotExistsSync(path.join(__dirname, 'datasets', 'del', 'data_1', 'test'));
